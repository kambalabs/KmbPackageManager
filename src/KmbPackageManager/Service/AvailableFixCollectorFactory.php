...
class AvailableFixCollectorFactory implements FactoryInterface
{
    /**
     * Create service
     *
    ...
    {
        $service = new AvailableFixCollector();
        /** @var Service\Node $nodeService */
        $nodeService = $serviceLocator->get('KmbPuppetDb\Service\Node');
        $service->setPatchRepository($serviceLocator->get('PatchRepository'));
